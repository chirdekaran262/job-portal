...
import { getCompanyReviews, addCompanyReview } from '../services/reviewService';
...
const JobDetails = () => {
    ...
    useEffect(() => {
        const fetchCompanyReviews = async () => {
            if (job?.company?.id) {
                try {
                    const reviews = await getCompanyReviews(job.company.id);
    ...
    const handleReviewSubmit = async (e) => {
        ...
        try {
            ...
            const addedReview = await addCompanyReview(job.company.id, newReview);

            // Update reviews list with new review
            setCompanyReviews(prev => [...prev, addedReview]);
            ...
            setApplyStatus({
                message: err.message || "Failed to add review. Please try again.",
                type: "error"
            });
        }
    };
    ...
    return (
        <div className="farm-job-details bg-green-50 p-8 rounded-2xl shadow-lg">
            <div className="farm-job-container">
                ...
                <div className="farm-job-main">
                    ...
                    <div className="card farm-job-card bg-gradient-to-br from-green-400 via-yellow-100 to-yellow-200 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 overflow-hidden">
                        {/* --- Job Header --- */}
                        <div className="card-header farm-job-header bg-gradient-to-r from-green-500 to-yellow-400 text-white p-8 rounded-tl-2xl rounded-tr-2xl">
                        ...
                        {description && (
                            <>
                                <div className="farm-job-section bg-gradient-to-br from-yellow-100 to-white p-4">
                        ...
                        {/* --- Job Footer --- */}
                        <div className="farm-job-footer bg-gradient-to-r from-green-400 to-green-200 p-4 rounded-b-2xl">
                            <div className="farm-job-deadline bg-gradient-to-r from-red-500 to-red-400 p-4 rounded-b-2xl text-white">
                    ...
                    <div className="card farm-resources bg-gradient-to-br from-green-300 to-yellow-400 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 overflow-hidden">
                ...
                <div className="farm-job-sidebar">
                    ...
                    {showApplyForm ? (
                        ...
                        <div className="card farm-company-card bg-gradient-to-br from-green-300 to-yellow-400 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 overflow-hidden">
                            <div className="card-header farm-company-header bg-gradient-to-r from-green-500 to-yellow-500 text-white p-4 rounded-tl-2xl rounded-tr-2xl">
                                <div className="farm-company-logo">
                                    <img src={companyLogo} alt={`${companyName} logo`} />
                                </div>
                                <div>
                                    <h3>{companyName}</h3>
                                    <p className="text-sm font-bold text-gray-600">About the Employer</p>
                                </div>
                            </div>
                    ...
                    <div className="card farm-reviews-card bg-gradient-to-br from-yellow-200 to-yellow-100 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border border-gray-100 overflow-hidden">
                        <div className="card-header farm-reviews-header bg-gradient-to-r from-green-500 to-yellow-400 text-white p-4 rounded-tl-2xl rounded-tr-2xl">
                        ...
                        {showReviewForm && (
                            <div className="review-form-container bg-white p-4 rounded-b-2xl">
